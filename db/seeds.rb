...
bonobo = User.create!(first_name: 'Bon', last_name: 'Obo', location: 'Cape Town', dob: '1989-09-14', email: 'bonobo@example.com', password: '123456', artist: true, artist_name: 'Bonobo', bank_details: '121212 12345678', spotify: 'https://open.spotify.com/artist/0cmWgDlu9CwTgxPhf403hb', facebook: 'https://www.facebook.com/diegophilips/', instagram: 'https://www.instagram.com/dphilips/', youtube: 'https://www.youtube.com/embed/ERLy4Dam1pU',  bio: "Bonobo's rise has been stealthy but unstoppable and Simon Green, the man behind it all, is now one of the biggest electronic artists of our time, with 6 albums and a revered live show that has seen him play to sold-out crowds across the globe, including multiple shows at Alexandra Palace, Glastonbury, Coachella and Red Rocks Amphitheat.")
